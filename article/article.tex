...
\fancyfoot[R]{\sffamily Apr 2016 $\vert$
                        Volume \textbf{2} $\vert$
                        Issue \textbf{1}}
\pagestyle{fancy}
\makeatletter
...
\marginpar{
  ...
  {\bfseries Received}  Feb, 23, 2016\\
  {\bfseries Accepted}  Apr, 13, 2016\\
  {\bfseries Published} Apr, 22, 2016\\
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Petchey-Plebani-Pennekamp-2016/tree/master/article}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Petchey-Plebani-Pennekamp-2016/tree/master/code}{\faGithubAlt~Code repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Petchey-Plebani-Pennekamp-2016/tree/master/data}{\faGithubAlt~Data repository}
  \end{repobox}
      \hypersetup{urlcolor=blue}
}
